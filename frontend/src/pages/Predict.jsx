...
export default function Predict() {
  ...
  // FIX: load areas for the initial city on mount
  useEffect(() => {
    const initCity = globalCity || form.city;
    if (initCity) loadAreas(initCity);
  ...
  async function runPrediction() {
    ...
    setResult(null);
    try {
      const r = await getPricePrediction({ ...form, city: cityVal, area: customArea || form.area, country });
      setResult(r);
    } catch (e) {
