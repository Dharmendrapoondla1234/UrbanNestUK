...
export default function Advisor() {
  ...
  // FIX: build greeting dynamically so it reflects current country/city,
  // and reset chat when country changes so context stays relevant
  useEffect(() => {
    setMessages([{
      role: 'assistant',
      text: `Hello! I'm your AI property advisor with expertise in global real estate markets. I can help with area recommendations, investment analysis, price guidance, legal processes, financing, and much more.\n\nCurrently focused on: ${country}${city ? ` · ${city}` : ''}.\n\nWhat would you like to know?`
    }]);
    setError(null);
  }, [country, city]);
  ...
  function clearChat() {
    setMessages([{ role: 'assistant', text: `Chat cleared. I'm ready to help with ${country}${city ? ` · ${city}` : ''} property questions. What would you like to know?` }]);
    setError(null);
  }
